...
// "Battle Result: Evil eradicates all trace of Good" if evil wins, or "Battle Result:
...
function goodVsEvil(good, evil) {
    ...
    const sumCount = (str, arr) => str.split(' ').reduce((a, b, i) => a + b * arr[i], 0)

    const goodCount = sumCount(good, goodArr)
    const evilCount = sumCount(evil, evilArr)
