  ...
  // I'll just stay where I am located (examples: you can't go lower than lowest row: Ken, Chun Li, Zangief, Dhalsim,
  // Sagat and M.Bison in the above image; you can't go upper than highest row: Ryu, E.Honda, Blanka, Guile, Balrog and
  // Vega in the above image).
  //
  // Test
  //
  ...
  function streetFighterSelection(fighters, position, moves) {
      ...
      for (let move of moves) {
          if (move === 'right') {
              if (players[1] === fighters[1].length - 1) {
                  players[1] = 0
                  arrStep.push(fighters[players[0]][players[1]])
              } else {
                  players[1]++
                  arrStep.push(fighters[players[0]][players[1]])
              }
